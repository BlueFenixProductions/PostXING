...
public class GenericDockablePlugin : UserControl, IPlugin
{
	private Icon m_icoIcon;

	private Container components;

	protected AppContext m_appContext;

	protected string m_Name = "DockablePlugin";

	protected string m_menuCaption = "&My simple dockable plugin";
	...
	public virtual PluginTypes PluginType => PluginTypes.Dockable;
