...
public class HtmlEntity
{
	...
	public static Hashtable EntityName => _entityName;

	public static Hashtable EntityValue => _entityValue;
	...
	{
		foreach (HtmlAttribute item in collection)
		{
	...
	public static string Entitize(string text, bool useNames, bool entitizeQuotAmpAndLtGt)
	{
		...
		for (int i = 0; i < text.Length; i++)
		{
			...
			{
				if (!(_entityName[num] is string text2) || !useNames)
				{
				...
				case ';':
					...
					else
					{
						if (stringBuilder2[0] == '#')
						{
							...
							try
							{
								int value = Convert.ToInt32(text2.Substring(1, text2.Length - 1));
						...
						{
							object obj2 = _entityValue[stringBuilder2.ToString()];
							if (obj2 == null)
							{
